 ...
 */
public class AutoTrenchFromCenterOLD extends SequentialCommandGroup {
   ...
   */  
  public AutoTrenchFromCenterOLD(Trajectory trajectory, DifferentialDriveKinematics driveKinematics, DriveTrain driveTrain, Shooter shooter, Feeder feeder, Hopper hopper, 
