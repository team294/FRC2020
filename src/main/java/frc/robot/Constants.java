...
public final class Constants {
    ...
    public static final class ShooterConstants {
        ...
        public static final double shooterDefaultShortRPM = 1200;
    ...
    public static final class LimeLightConstants {
        ...
        public static final double unlockedHoodMaxDistance = 12; // greatest feet away from target that hood needs to be unlocked to make shot
    }
