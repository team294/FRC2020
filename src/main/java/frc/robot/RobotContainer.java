...
public class RobotContainer {
  ...
  public void configureShuffleboard() {
    ...
    SmartDashboard.putData("DriveStraight", new DriveStraight(3, TargetType.kRelative, 0.0, 2.66, 3.8, true, driveTrain, limeLight, log));
    ...
    SmartDashboard.putData("DriveStraightManual", new DriveStraight(TargetType.kRelative, 0.0, true, driveTrain, limeLight, log));
